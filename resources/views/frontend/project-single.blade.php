...
<div class="page__banner" data-background="{{asset('assets/frontend/assets/img/pages/page-banner.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
            ...
            <div class="col-xl-12">
                <div class="project__details-area">
                    <div class="project__details-area-image dark__image">
                        <img src="{{asset('assets/frontend/assets/img/portfolio/project-details.jpg')}}" alt="">
                    </div>
                    ...
                    <div class="row mt-35 mb-40 dark__image">
                        <div class="col-sm-4 sm-mb-30">
                            <img class="img__full" src="{{asset('assets/frontend/assets/img/portfolio/project-details-1.jpg')}}" alt="">
                        </div>
                        <div class="col-sm-4 sm-mb-30">
                            <img class="img__full" src="{{asset('assets/frontend/assets/img/portfolio/project-details-2.jpg')}}" alt="">
                        </div>
                        <div class="col-sm-4">
                            <img class="img__full" src="{{asset('assets/frontend/assets/img/portfolio/project-details-3.jpg')}}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="project__details-pagination">
                        <div class="project__details-pagination-item">
                            <a href="#">
                                <div class="project__details-pagination-item-left dark__image">
                                    <img src="{{asset('assets/frontend/assets/img/portfolio/prev.jpg')}}" alt="">
                        ...
                        <div class="project__details-pagination-item center">
                            <div class="project__details-pagination-item-icon">
                                <img src="{{asset('assets/frontend/assets/img/icon/menu.png')}}" alt="">
                            </div>
                        </div>
                        <div class="project__details-pagination-item">
                            <a href="#">
                                ...
                                <div class="project__details-pagination-item-left dark__image">
                                    ...
                                    <img src="{{asset('assets/frontend/assets/img/portfolio/next.jpg')}}" alt="">
                                </div>
                            </a>
                        </div>
                    </div>  
