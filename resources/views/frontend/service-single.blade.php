            ...
            <div class="col-xl-8 col-lg-8 lg-mb-60">
                <div class="services__details-left">
                    <div class="services__details-left-image dark__image">
                        <img src="{{asset('assets/frontend/assets/img/pages/services-details.jpg')}}" alt="">
                    </div>
                ...
                <div class="all__sidebar">
                    ...
                    <div class="all__sidebar-item">
                        ...
                        <div class="all__sidebar-item-download">
                            <ul>                                    
                                <li><a href=""><img src="{{asset('assets/frontend/assets/img/icon/pdf.png')}}" alt="">Our Brochures<i class="fal fa-arrow-to-bottom"></i></a></li>
                                <li><a href=""><img src="{{asset('assets/frontend/assets/img/icon/document.png')}}" alt="">Company Details<i class="fal fa-arrow-to-bottom"></i></a></li>
                            </ul>                            
                        </div>
                    </div>
                    <div class="all__sidebar-help">
                        <div class="all__sidebar-help-image">
                            <img class="img__full" src="{{asset('assets/frontend/assets/img/pages/help.jpg')}}" alt="">
                            <div class="all__sidebar-help-image-content">
                                <img src="{{asset('assets/frontend/assets/img/favicon-1.png')}}" alt="">
