    ...
    <main class="d-flex w-100 h-100">
        <div class="container d-flex flex-column p-5">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">{{ __('Create Memberships') }}</div>
                            ...
                            <form method="POST" action="{{ route('memberships.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="membership_fee" type="text"
                                           ...
                                           name="membership_fee" value="{{ old('membership_fee') }}" autofocus>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea
                                        ...
                                        name="payment_procedure"></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="register_online_link" type="text"
                                           ...
                                           name="register_online_link" value="{{ old('register_online_link') }}"
                                           autofocus>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="website_link" type="text"
                                           ...
                                           name="website_link" value="{{ old('website_link') }}" autofocus>
                                    @error('website_link')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="query_email" type="email"
                                           ...
                                           name="query_email" value="{{ old('query_email') }}" autofocus>
                                    @error('query_email')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="whatsapp_no" type="text"
                                           ...
                                           name="whatsapp_no" value="{{ old('whatsapp_no') }}" autofocus>
                                    @error('whatsapp_no')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
